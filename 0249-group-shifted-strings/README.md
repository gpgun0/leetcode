<h2><a href="https://leetcode.com/problems/group-shifted-strings">249. Group Shifted Strings</a></h2><h3>Medium</h3><hr><p>Perform the following shift operations on a string:</p>
